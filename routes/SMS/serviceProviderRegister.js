...
router.post("/serviceProviderRegisterOTP", async (req, res) => {
  try {
...
// POST route to verify the OTP and create user
router.post("/serviceProviderRegisterVerify", async (req, res) => {
  try {
    ...
    if (otp == storedOTP) {
      ...
      // Save user details in Firestore Clients collection
...
// POST route to check if the phone number exists in the users' collection
router.post("/serviceProviderRegisterCheck", async (req, res) => {
  const { phoneNumber } = req.body;

  try {
    // Query Firestore to check if the phone number exists in the 'Clients' collection
