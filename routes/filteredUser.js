...
router.post("/filteredUser", async (req, res) => {
  try {
    ...
    snapshot.forEach((doc) => {
      ...
      const hasBarbershopOrSpa =
        ...
        (userData.businesscategories.includes("Barbershop") ||
          userData.businesscategories.includes("Spa"));

      if (hasBarbershopOrSpa) {
        ...
        usersWithDistance.push({
          ...
          distance: formattedDistance, // Round to 2 decimal places
